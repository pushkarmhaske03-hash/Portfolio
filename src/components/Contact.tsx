  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/pushkar174-coder",
    },
    {
      name: "LinkedIn",
      icon: <IconBrandLinkedin className="w-5 h-5" />,
      url: "https://www.linkedin.com/in/pushkar-mhaske-71a710291/",
    },
    {
      name: "Twitter",
      icon: <IconBrandTwitter className="w-5 h-5" />,
      url: "https://x.com/Pushkar_0095?t=0t1v9bjhKzb2EjmeXoo8ig&s=09",
    },
  ];
